...
public class RankingData {
    ...
    public int getWinRank(String playerName) {// 获取胜场榜排名
        int n = 0;
    ...
    public String getPlayerByWinRank(int ranking) {// 获取胜场榜排名对应的玩家
    ...
    public int getKDRank(String playerName) {// 获取KD榜排名
        List<String> ranking = Main.getInstance().getCacheHandler()
                .getRanking().getKD();
        int n = 0;
        if (ranking.size() == 0) {
    ...
    public String getPlayerByKDRank(int ranking) {// 获取KD榜排名对应的玩家
        List<String> rankingList = Main.getInstance().getCacheHandler()
                .getRanking().getKD();
        if (rankingList.size() < ranking) {
            return null;
